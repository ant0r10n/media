...
<table border="1" align="center">
  ...
  <?php do { ?>
    <tr>
      <td> <?php echo $row_rsArtist['type']; ?>&nbsp; </td>
      <td><a href="item.php?recordID=<?php echo $row_rsArtist['id']; ?>"><?php echo $row_rsArtist['title']; ?></a>&nbsp; </td>
      <td><?php echo $row_rsArtist['artist']; ?>&nbsp; </td>
      <td><?php echo $row_rsArtist['image']; ?>&nbsp; </td>
    </tr>
...
Records <?php echo ($startRow_rsArtist + 1) ?> to <?php echo min($startRow_rsArtist + $maxRows_rsArtist, $totalRows_rsArtist) ?> of <?php echo $totalRows_rsArtist ?>
<!--end DW CODE--->
